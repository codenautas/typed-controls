...
TypedControls.adaptElement = function adaptElement(domElement, typeInfo){
    ...
    console.log('xxxxxxxxx777',typedControlsOptionGroup,domElement.tagName,typeInfo)
    if(typedControlsOptionGroup){
        var inputTypeRadio=[];
    ...
    domElement.setTypedValue = function setTypedValue(typedValue){
        ...
        console.log('xxxxxxxxxxxxxx=',typedValue,this.tagName,this.innerHTML,this.typedControlViaValue,typer,typer.toPlainString,typedValue && typedValue.toPlainString)
