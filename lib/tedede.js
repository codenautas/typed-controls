...
function control2(domElement){
    ...
    if(tededeOptionGroup){
        ...
        [true,false].forEach(function(value){
            var childId=document.getElementById(tededeOptionGroup+'-'+value);
            if(childId.name!=tededeOptionGroup) {
...
function control3y4(domElement){
    var tededeOptionGroup=domElement.getAttribute("tedede-option-group");
    if(tededeOptionGroup){
        [true,false].forEach(function(value){
            var childId=document.getElementById(tededeOptionGroup+'-'+value);
            if(childId.tagName!='INPUT'){
