...
function control1(domElement){
    // tedede-option-group must match id
    var tededeOptionGroup=domElement.getAttribute("tedede-option-group");
    //console.log("############# PRIMER TEST",tededeOptionGroup,domElement['id'])
    if(tededeOptionGroup){
...
function control3(domElement){
    ...
    if(tededeOptionGroup){
        console.log("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@",tededeOptionGroup);
       // var prueba=document.getElementByName(tededeOptionGroup);
