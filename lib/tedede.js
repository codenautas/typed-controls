...
BestTypes["boolean"] = {
    adapters:{
        ...
        getTypedValue: function getTypedValueBoolean(){
            var tededeOptionGroup=this["tedede-option-group"] || this.getAttribute("tedede-option-group");
        ...
        setValidatedTypedValue: function setValidatedTypedValuePrettyBoolean(typedValue){
           // var attr="tedede-option-group";
            var tededeOptionGroup=this["tedede-option-group"]|| this.getAttribute("tedede-option-group");
           // console.log("###########################3 tededeOptionGroup       ",tededeOptionGroup);
            if(tededeOptionGroup){
                [true, false].forEach(function(value){
//                    document.getElementById('bool2'+'-'+value).checked = value===typedValue;
                    document.getElementById(tededeOptionGroup+'-'+value).checked = value===typedValue;
                   console.log("##############  get element by id", tededeOptionGroup+'-'+value);
                });
            }else if(this.type==='checkbox'){
