...
Tedede.optionsCtrl = function optionsCtrl(id, options){
    id = id || ('tedede'+iiiiiiid++);
...
Tedede.booleanCtrl =function booleanCtrl(id){
    return Tedede.optionsCtrl(id,{true:{label:'Sí'}, false:{label:'No'}});
}
