    ...
    [
        ...
        it("must receieve key 'h' and change the internal typed value to current date", function(done){
            ...
            var skip = NOT_SUPPORTED_SITUATION({
                ...
                excluding: 'IE 11.0, PhantomJS 2.1.1, Firefox 31.0, Firefox 39.0, Firefox 43.0, Firefox 44.0, Firefox 45.0, Firefox 47.0, Firefox 49.0, Firefox 50.0, Firefox 52.0, Firefox 53.0'.split(', '),
